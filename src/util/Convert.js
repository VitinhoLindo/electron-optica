export default function() {
  ...
  class Convert {
    ...
    stringToBase64(string = '') {
      let buffer = this.stringToBuffer(utf8_encode(string))
    ...
    base64ToString(base64 = '') {
      ...
      return utf8_decode(this.bufferToString(buffer))
    }
    ...
    bufferToBase64(buffer = new ArrayBuffer(0)) {
      ...
      while (i < array.length) {
        ...
        output = output +
                 constants.keys.charAt(enc1) + 
                 constants.keys.charAt(enc2) +
                 constants.keys.charAt(enc3) + 
                 constants.keys.charAt(enc4);
      }
    ...
    base64ToBuffer(base64 = '') {
      ...
      while (i < base64.length) {
        enc1 = constants.keys.indexOf(base64.charAt(i++));
        enc2 = constants.keys.indexOf(base64.charAt(i++));
        enc3 = constants.keys.indexOf(base64.charAt(i++));
        enc4 = constants.keys.indexOf(base64.charAt(i++));
